  ...
  const initializeAvatarSession = async () => {
    try {
      ...
      const data = await newAvatar.createStartAvatar({
        ...
        // Por defecto es 120 segundos (2 minutos)
        activityIdleTimeout: 120,
        // Para sesiones más largas (requiere plan adecuado de HeyGen):
        // activityIdleTimeout: 600, // 10 minutos
        // activityIdleTimeout: 3600, // 1 hora
        // Nota: disableIdleTimeout está deprecado, usar activityIdleTimeout en su lugar
      })
